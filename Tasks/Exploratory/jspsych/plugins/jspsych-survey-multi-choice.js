...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var cssstr = ".jspsych-survey-multi-choice-question { margin: 1em; text-align: left; display: inline-block}"+
      ".jspsych-survey-multi-choice-text span.required {color: darkred;}"+
      ".jspsych-survey-multi-choice-horizontal{  text-align: center; } .jspsych-survey-multi-choice-text {  text-align: center; }"+
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      // if (trial.questions[i].horizontal) {
      //   display_element.innerHTML += '<div id="options_group">'
      // }
    ...
    // add submit button
    trial_form.innerHTML += '<br><input type="submit" id="'+plugin_id_name+'-next" class="'+plugin_id_name+' jspsych-btn"' + (trial.button_label ? ' value="'+trial.button_label + '"': '') + '></input>';
