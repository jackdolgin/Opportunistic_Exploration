  ...
  plugin.trial = function(display_element, trial) {
    ...
    var display_stimuli = function(stage){
      ...
      if (stage ==1){
        ...
        cent_l.innerHTML += '<div id="jspsych-box0-l"></div><div id="jspsych-box1-l"></div><div id="jspsych-box2-l"></div><div id="jspsych-box3-l"></div><div id="jspsych-box4-l"></div>'
        ...
        if (trial.horizon==long_horizon){
          cent_l.innerHTML +=  '<div id="jspsych-box5-l"></div><div id="jspsych-box6-l"></div><div id="jspsych-box7-l"></div><div id="jspsych-box8-l"></div>'
          cent_r.innerHTML +=  '<div id="jspsych-box5-r"></div><div id="jspsych-box6-r"></div><div id="jspsych-box7-r"></div><div id="jspsych-box8-r"></div>'
          cent_stim.innerHTML += '<div id="jspsych-center-box5"></div><div id="jspsych-center-box6"></div><div id="jspsych-center-box7"></div><div id="jspsych-center-box8"></div><div id="jspsych-center-box9"></div>'
        }
        ...
        box_8 = content.querySelector('#jspsych-box8-l')
        ...
        box_8_r = content.querySelector('#jspsych-box8-r')
        ...
        center_box_8 = content.querySelector('#jspsych-center-box8')
    ...
    var next_trial = function(){
      ...
      if (current_trial<4){
        ...
        current_center.innerHTML = '<img src = "img/'+trial.forced_choice[current_trial]+'_arrow.png" width="110" height="80">'
